...
# ========================================================================
# Load Meditron 7B Model for Validation Agent
# ========================================================================
print("Loading Meditron 7B model for Validation Agent...")
validation_model_id = "epfl-llm/meditron-7b"
...
print("Meditron Validation Agent loaded successfully.\n")
...
class TransformerValidationAgent:
    """
    Uses Meditron-7B to evaluate conversation completeness.
    ...
    def evaluate_completeness(self, conversation_history):
        ...
        conversation = "\n".join([f"Patient: {msg}" for msg in conversation_history[-5:]])  # Last 5
...
"""
        ...
        if match:
            try:
                ...
                # Force progression - don't repeat same category
        ...
        # Rule-based progression - enforces conversation flow
        progression = {
...
class QuestionGeneratorAgent:
    ...
    def generate_question(self, conversation_history, missing_category):
        # First, try to use a smart fallback directly (fast)
        ...
        # If needed, attempt generation (slower)
        try:
            recent_context = " ".join(conversation_history[-2:])  # Only last 2
...
# ========================================================================
# Doctor Agent - Uses Meditron for Report Generation
# ========================================================================
class DoctorAgent:
    """
    Generates comprehensive medical assessment reports using Meditron-7B
    """

    def __init__(self, val_model, val_tokenizer):
        """Uses Meditron model for medical report generation"""
        self.model = val_model
        self.tokenizer = val_tokenizer

    def generate_report(self, conversation_history):
        """Generate medical assessment using Meditron"""
...
def interactive_consultation():
    ...
    doctor_agent = DoctorAgent(val_model, val_tokenizer)  # Use Meditron for reports
    print("[Agents ready]\n")
